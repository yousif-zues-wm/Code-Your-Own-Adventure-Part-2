...
function Main()
{
	...
	Water.description="Water, leaves and fish";
	Water.UsableWith("Barrel",FillBarrel);
	
	Undies=CreateObject("Undies",710,215);
	Undies.description="Some Smexy undies.";
	Undies.Resize(40);
	
	if(SearchParameter("TalkedwithGrandad"))
	{
		Undies.description="Aha! I can short circut robots with it.";
		Undies.Takable();
	}
	...
	Stick.description="It's used for drying wet chlothes.";
	Stick.Resize(70);
