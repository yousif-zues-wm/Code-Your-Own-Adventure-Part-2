...
function Main()
{
	...
	Pic3.description="It says: 'its a riddle now isnt it?'";  
	...
	Sword4.description="More swords... soo many swords...";  
	
	//-Table
	Table=CreateInvisibleObject("573,215,573,135,618,137,616,218");
	Table.description="Oh! a mirror am i really this old";
	...
	Window2.description="it Goes to the outside.";
	...
	if(SearchParameter("YingFingRanaway"))
	{
		...
		Mainroomdoor.description="its a Door to the main room.";
	}
...
function controlVampire()
{
	if(ObjectToUse()=="Spell")
	{
		...
		Player.Say("Done, now the robot will follow me");
		Vampire.StopPath();
